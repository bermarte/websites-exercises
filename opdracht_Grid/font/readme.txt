...
True Type Font: High Sans Serif 7 version 1.0


EULA
-==-
The font High Sans Serif 7 is freeware. You may use it for commercial purposes (see 'NOTES' section).


DESCRIPTION
-=========-
High and narrow sans serif font. Cyrillic code page is supported.

Files in high_sans_serif_7.zip:
       	readme.txt     			this file;
        high_sans_serif_7.ttf 		regular font;
	high_sans_serif_7_screen.png	preview image.
